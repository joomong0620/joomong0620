...
> 안녕하세요! **"새로운 기술을 배우고 실제 서비스에 적용해보는 것을 좋아하는"** 김주연입니다!  
> 실제 프로젝트를 만드는 과정에서 **요구사항 분석, DB 모델링, API 개발** 과 같은 백엔드 핵심 역량을 체계적으로 다졌습니다.
...
> 그동안 진행했던 프로젝트 입니다!
> 팀장으로서는 운영적인 면과 **기획·개발 방향성 설정, 일정 관리, 코드 품질 관리**, 프로젝트 일정 관리 등 협업 능력을 강화했습니다.
> 새로운 기술을 빠르게 학습하고 이해한 내용을 팀원들과 공유하며 함께 성장하는 개발 문화를 지향합니다.
> 더 자세한 프로젝트 및 기술 경험은 아래 링크에서 확인하실 수 있습니다.
